(() => {
    ...
    const input1 = document.querySelector('#task18_1')
    const input2 = document.querySelector('#task18_2')
    const input3 = document.querySelector('#task18_3')
    const input4 = document.querySelector('#task18_4')
    const input5 = document.querySelector('#task18_5')
    const input6 = document.querySelector('#task18_6')
