(() => {
    ...
    const play2 = document.querySelector('.task3_play2')
    const play3 = document.querySelector('.task3_play3')
    const play4 = document.querySelector('.task3_play4')
    const play5 = document.querySelector('.task3_play5')
