(() => {
    ...
    const pictures = [{
            id: 1,
            src: 'Images_5/assets4/task7_1.png',
            text: 'Посмотри на числовой луч. Можем ли мы его продолжить? Какое число будет стоять после числа 8?'
        },
        {
            id: 2,
            src: 'Images_5/assets4/task7_2.png',
            text: 'Верно. Это число 9. Сколько шагов надо сделать по числовому лучу от точки 8, чтобы получить число 9?'
        },
        {
            id: 3,
            src: 'Images_5/assets4/task7_3.png',
            text: `Верно. Один шаг.`
        },
        {
            id: 4,
            src: 'Images_5/assets4/task7_4.png',
            text: 'На сколько 9 больше 8? На сколько 8 меньше 9?'
        },
        {
            id: 5,
            src: 'Images_5/assets4/task7_5.png',
            text: 'Верно. 9 больше 8 на 1. 8 меньше 9 на 1.'
        }
    ]
