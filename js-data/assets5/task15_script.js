(() => {
    ...
    const input1 = document.querySelector('#task15_select_1')
    const input2 = document.querySelector('#task15_select_2')
    const input3 = document.querySelector('#task15_select_3')
    const input4 = document.querySelector('#task15_select_4')
    const input5 = document.querySelector('#task15_select_5')
    const input6 = document.querySelector('#task15_select_6')
    const input7 = document.querySelector('#task15_select_7')
    const input8 = document.querySelector('#task15_select_8')
    const input9 = document.querySelector('#task15_select_9')
    const input10 = document.querySelector('#task15_select_10')
    const input11 = document.querySelector('#task15_select_11')
    const input12 = document.querySelector('#task15_select_12')
